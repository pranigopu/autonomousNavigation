...
### Windowed CA\* (WCA\*)
> **Key reference**: [_Cooperative Pathfinding (Academic Paper)_ by David Silver](https://dl.acm.org/doi/10.5555/3022473.3022494)
...
Quoting from [David Silver (Cooperative Pathfinding)](https://cw.fel.cvut.cz/b211/_media/courses/b3m33mkr/coop-path-aiwisdom.pdf):
